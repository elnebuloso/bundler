...
/**
 * Class BundleJavascriptTask
 *
 * @package PhingCommons\Bundle
 * @author Jeff Tunessen <jeff.tunessen@gmail.com>
 */
class BundleJavascriptTask extends AbstractBundlePublicTask {
    ...
    private function _compileWithYuiCompressor() {
        ...
        $compiler = $path . '/third-party/yuicompressor/2.4.8/yuicompressor.jar';
    ...
    private function _compileWithGoogle() {
        ...
        $compiler = $path . '/third-party/google/compiler.jar';
